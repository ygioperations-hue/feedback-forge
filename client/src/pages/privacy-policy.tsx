      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-foreground">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li><strong className="text-foreground">Stripe</strong> — Payment processing. Your payment data is governed by <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">Stripe's Privacy Policy</a>.</li>
              <li><strong className="text-foreground">OpenAI</strong> — Powers the AI insights feature. Feedback text you submit for analysis is sent to OpenAI's API. OpenAI does not use API data to train its models by default. See <a href="https://openai.com/policies/api-data-usage-policies" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">OpenAI's API data usage policy</a>.</li>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To exercise any of these rights, contact us at <a href="mailto:support@feedbackforge.co" className="underline hover:text-foreground">support@feedbackforge.co</a>.
            </p>
          </section>
