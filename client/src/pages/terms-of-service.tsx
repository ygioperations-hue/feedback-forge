...
export default function TermsOfService() {
  usePageSEO({
    ...
    description: "Read FeedbackForge's Terms of Service covering account registration, the $59 Lifetime Deal, acceptable use, and your rights.",
    canonicalPath: "/terms",
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-3xl font-bold tracking-tight mb-2 text-foreground">Terms of Service</h1>
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-foreground">3. Lifetime Deal — Billing and Payment</h2>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <p className="text-muted-foreground leading-relaxed">
              All payments are processed securely by Stripe. By completing a purchase, you agree to Stripe's Terms of Service. All sales are final. Refunds may be issued at our discretion within 14 days of purchase if the Service does not function as described — contact us at <a href="mailto:support@feedbackforge.co" className="underline decoration-muted-foreground hover:text-foreground hover:decoration-foreground transition-colors">support@feedbackforge.co</a>.
            </p>
            <p className="text-muted-foreground leading-relaxed">
